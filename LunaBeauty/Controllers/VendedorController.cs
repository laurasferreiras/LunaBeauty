...
namespace LunaBeauty.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public VendedorController(LunaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,Nome,Matricula")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorId,Nome,Matricula")] Vendedor vendedor)
        {
